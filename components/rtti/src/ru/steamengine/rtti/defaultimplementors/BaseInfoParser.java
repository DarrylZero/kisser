    ...
    public RTTIEntry parseInfo(Class clazz, String info) {
        ...
        switch (getterAccessorType) {
            ...
            case field:
                ...
                getter = getField;
                if (getField == null)
                    throw new IllegalArgumentException("field " + clazz.getName() + "." + getterFieldName + " does not exist");
            ...
            case method:
                ...
                getter = getMethod;
                if (getMethod == null)
                    throw new IllegalArgumentException("method " + clazz.getName() + "." +
        ...
        if (propSetterName == null) {
            ...
            switch (setterAccessorType) {
                case field:
                    ...
                    setter = setField;
                    if (setField == null)
                        throw new IllegalArgumentException("field " + clazz.getName() + "." +
                                setterFieldName + " does not exist");

                    if (isFinal(setField))
                        throw new IllegalArgumentException("field " + clazz.getName() + "." +
                                setterFieldName + " can not be final");
                ...
                case method:
                    ...
                    setter = setMethod;
                    if (setMethod == null)
                        throw new IllegalArgumentException("method " + clazz.getName() + "." +  setterMethodName +
                                "()  does not exist");
