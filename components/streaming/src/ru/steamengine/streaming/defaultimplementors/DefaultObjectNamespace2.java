 ...
 */
public class DefaultObjectNamespace2 implements ObjectNamespace {
    ...
    public DefaultObjectNamespace2(ObjectResolver objectResolver) {
    ...
    public Object findObject(String name) {
        ...
        if (objectResolver != null)
            o = objectResolver.findObject(name);
